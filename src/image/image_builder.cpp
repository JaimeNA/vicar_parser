...
ImageBuilder::ImageBuilder(const std::string filename, std::size_t width, std::size_t height, int pixel_size) {
    ...
    if (!file) {
        std::cerr << "ERROR::IMAGE_RENDERER: Error opening file!" << std::endl;
    }
...
void ImageBuilder::put_pixel(int x, int y, int value) {
    std::cout << "OWO" << std::endl;    // TODO: Proper implementation
}

/* Draws a square, the top-left corner has the position specified */
void ImageBuilder::draw_square(int x, int y, int size, int value) {
...
void ImageBuilder::draw_char(char c, int font_size, int x, int y, int value) {
